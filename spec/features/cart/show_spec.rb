...
RSpec.describe 'Cart show' do
  ...
  describe "When I have enough of an item to obtain a bulk discount" do
    ...
    it "correctly represents subtotal and individual item price with the bulk discount" do
      bike_shop = Merchant.create(
        name: "Brian's Bike Shop",
        address: '123 Bike Rd.',
        city: 'Richmond',
  ...
  it "calculates subtotal when an item does not have a discount or does not meet quantity requirements" do
    bike_shop = Merchant.create(
      name: "Brian's Bike Shop",
      address: '123 Bike Rd.',
      city: 'Richmond',
