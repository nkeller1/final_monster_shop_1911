...
RSpec.describe("Order Creation") do
  ...
  it "can create an order with discounts applied" do
    ...
    it "does not change a discounted order if the discount changes" do
      click_on "Logout"
    ...
    it "can create an order with an item that has a discount but not enough quantity" do
      click_on "Logout"
      ...
      expect(page).to have_content("Grand Total: $30.0")
      expect(page).to have_content("Subtotal: $30.0")
      expect(page).to have_content("Item Price: $10.0")
    end
  end
end
